      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <div className="absolute bottom-3 left-3">
            <span className="font-mono-tech text-[9px] tracking-widest uppercase text-text-on-dark/60 bg-black/40 backdrop-blur-sm rounded-full px-2.5 py-0.5">
              📍 Denver, Colorado
            </span>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-text-on-dark/55 text-sm leading-relaxed mb-3">
          ...
          <p className="text-text-on-dark/55 text-sm leading-relaxed">
        ...
        {differentiators.map((d, i) => (
          ...
          >
            ...
            <div>
              ...
              <p className="text-text-on-dark/45 text-[11px] leading-relaxed">{d.desc}</p>
            </div>
          </motion.div>
        ))}
      </div>
