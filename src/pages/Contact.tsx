            ...
            <div className="md:col-span-2 space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-text-on-dark/60 text-sm mt-1 leading-relaxed">
                    11821 Altura St<br />Commerce City, CO 80603
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:brainbritellc@gmail.com" className="text-text-on-dark/60 text-sm hover:text-secondary transition-colors">
                    brainbritellc@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+17204529304" className="text-text-on-dark/60 text-sm hover:text-secondary transition-colors">
                    (720) 452-9304
                  </a>
                </div>
              </div>
            ...
            <div className="md:col-span-3">
              <form onSubmit={handleSubmit} className="space-y-4 bg-white/[0.03] border border-white/10 rounded-2xl p-6 md:p-8">
                <div>
                  ...
                  <Input id="name" required maxLength={100} placeholder="Your name" className="bg-white/5 border-white/10 text-text-on-dark placeholder:text-text-on-dark/30 mt-1" />
                </div>
                <div>
                  <Label htmlFor="email" className="text-text-on-dark/70 text-xs">Email</Label>
                  <Input id="email" type="email" required maxLength={255} placeholder="you@company.com" className="bg-white/5 border-white/10 text-text-on-dark placeholder:text-text-on-dark/30 mt-1" />
                </div>
                <div>
                  <Label htmlFor="phone" className="text-text-on-dark/70 text-xs">Phone</Label>
                  <Input id="phone" type="tel" maxLength={20} placeholder="(555) 000-0000" className="bg-white/5 border-white/10 text-text-on-dark placeholder:text-text-on-dark/30 mt-1" />
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <label htmlFor="sms-non-marketing" className="text-text-on-dark/60 text-xs leading-relaxed cursor-pointer">
                      I consent to receive non-marketing text messages from BrainBrite LLC about appointment confirmations, reminders, and service updates. Message frequency may vary. Message &amp; data rates may apply. Text HELP for assistance, reply STOP to opt out.
                    </label>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Textarea id="message" maxLength={1000} placeholder="Tell us about your goals..." className="bg-white/5 border-white/10 text-text-on-dark placeholder:text-text-on-dark/30 mt-1 min-h-[80px]" />
                </div>
                <Button type="submit" disabled={loading} className="w-full bg-secondary hover:bg-amber-gold text-secondary-foreground rounded-xl font-semibold py-5">
